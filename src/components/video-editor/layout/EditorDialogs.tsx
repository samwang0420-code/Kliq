						...
						<DialogHeader>
							...
							<DialogDescription className="text-muted-foreground">
								{t(
									...
									"Name this project. It will be saved in your Kliq Projects folder.",
								)}
							</DialogDescription>
						</DialogHeader>
						<div className="py-4">
					...
					<DialogHeader>
						...
						<DialogDescription className="text-muted-foreground">
							{t(
								...
								"Your device does not support native capture. This could be for a variety of reasons we haven’t figured out yet. This doesn’t break Kliq, but it does make cursor smoothing impossible.",
							)}
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>
