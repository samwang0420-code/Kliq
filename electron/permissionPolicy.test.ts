...
const TRUSTED_DOCUMENT_BASE_URLS = [
	...
	"file:///C:/Program%20Files/Kliq/resources/app.asar/dist/index.html",
];
...
const FILE_HUD_URL =
	"file:///C:/Program%20Files/Kliq/resources/app.asar/dist/index.html?windowType=hud-overlay";
...
describe("isTrustedCaptureDocumentUrl", () => {
	...
	])("accepts a Kliq HUD document: %s", (candidateUrl) => {
	...
	it.each([
		...
		"file:///C:/Program%20Files/Kliq/resources/app.asar/dist/other.html?windowType=hud-overlay",
		"file:///C:/Program%20Files/Kliq/resources/app.asar/dist/index.html/child?windowType=hud-overlay",
		"data:text/html,recordly?windowType=hud-overlay",
		"not a url",
	])("rejects a non-Kliq capture document: %s", (candidateUrl) => {
...
describe("shouldGrantDisplayCapture", () => {
	...
	it.each([
		["another BrowserWindow", { isTrustedCaptureWindow: false }],
		["a subframe", { isMainFrame: false }],
		["a non-Kliq document", { currentDocumentUrl: "https://example.com/" }],
